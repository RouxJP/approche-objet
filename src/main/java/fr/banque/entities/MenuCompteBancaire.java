	...
	public static void main(String[] args) throws ParseException {
		...
		do {
			System.out.println( "***** Administration des comptes *****\r\n" + 
				...
				"3. Ajouter une op�ration � un compte\r\n" + 
			...
			switch( numMenu){
				...
				case 2 :
					...
					System.out.println("Le compte a �t� ajout� ");
				...
				case 3 :
					...
					System.out.println( comptesDaoMem);
					do {
						System.out.println( "Saisir le num�ro de compte concern� : ");
						numCpt = sc.next();
					}while( !comptesDaoMem.existe(numCpt));
	
					do {
						System.out.println( "Saisir le type d'op�ration : \n"
								+ "1 : Cr�dit \n"
								+ "2 : D�bit");
						typeOpe = sc.nextInt( );
					...
					do {
						System.out.println( "Saisir le montant de l'op�ration (positif) : ");
